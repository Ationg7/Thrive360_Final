    ...
    <ListGroup variant="flush">
      {(() => {
        ...
        const renderBadge = (status) => {
          const style =
            status === 'In Progress'
              ? { borderColor: '#FFC107', color: '#FFC107' } // yellow
              : { borderColor: '#198754', color: '#198754' }; // green
          ...
          return (
            <span
              ...
              style={{
                ...
                fontSize: '10px',
                fontWeight: 500,
                fontFamily: 'Poppins, sans-serif', // font applied here too
              }}
            >
              {status}
            </span>
        ...
        return (
          <>
            ...
            {joinedChallenges.map((challenge, index) => (
              <ListGroup.Item key={`joined-${index}`} className="px-3 py-2" style={{ fontFamily: 'Poppins, sans-serif' }}>
            ...
            {completedChallenges.map((challenge, index) => (
              <ListGroup.Item key={`completed-${index}`} className="px-3 py-2" style={{ fontFamily: 'Poppins, sans-serif' }}>
                <div className="d-flex justify-content-between align-items-center">
                  <h6 className="mb-0">{challenge.title}</h6>
